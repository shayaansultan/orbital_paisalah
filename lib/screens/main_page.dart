              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(child: Column(children:  [
                    Text("\$1100.00", style: Theme.of(context).textTheme.titleLarge),
                ...
                Row(
                  ...
                  IncomeExpenseCard(expenseData: ExpenseData("Income", "2000", Icons.arrow_upward_rounded), )),
                    SizedBox(
                      width: 16,
                    ),
                    Expanded(child: IncomeExpenseCard(expenseData: ExpenseData("Expense", "-900", Icons.arrow_downward_rounded), ))],
                ),
                const SizedBox(
                  height: 32.0,
                ),
